  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-link" href="index.jsp">Inserimento Candidati</a>
      </div>
    </div>
  </div>
</nav>
		...
		<tbody>
			<c:forEach items="${listacandidati}" var="listacandidati">
				<tr>
					...
					<td>
					<a href="AppoggioDettaglio?id=${listacandidati.id}&nome=${listacandidati.nome}&cognome=${listacandidati.cognome}&anno_nascita=${listacandidati.anno_nascita}&eta=${listacandidati.eta}
						...
						&greenpass=${listacandidati.greenpass}"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#ModeButton">Dettagli</button></a>
					</td>
					<td>
						<form action="Delete" method="post">
							<input type="hidden" name="id" id="id" value="${listacandidati.id}"/><button class="btn btn-danger" type="submit"> Elimina </button> 
						</form>
					</td>
					<td>
						<a href="Appoggio?id=${listacandidati.id}&nome=${listacandidati.nome}&cognome=${listacandidati.cognome}&anno_nascita=${listacandidati.anno_nascita}&eta=${listacandidati.eta}
						&residenza=${listacandidati.residenza}&telefono=${listacandidati.telefono}&email=${listacandidati.email}&titolo_studio=${listacandidati.titolo_studio}&voto=${listacandidati.voto}
						&formazione=${listacandidati.formazione}&data_candidatura=${listacandidati.data_candidatura}&data_colloquio=${listacandidati.data_colloquio}&note=${listacandidati.note}&esito=${listacandidati.esito}
						&greenpass=${listacandidati.greenpass}"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModeButton">Modifica</button></a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
		...
		<tbody>
			<c:forEach items="${listacandidati}" var="listacandidati">
				<tr>
					...
					<td>
						<form action="Delete" method="post">
							<input type="hidden" name="IdU" id="IdU" value="${list.id}"/><button class="btn btn-danger" type="submit"> Elimina </button> 
						</form>
					</td>
					<td>
						<a href="Appoggio?id=${list.id}&nome=${list.nome}&cognome=${list.cognome}&eta=${list.eta}"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModeButton">Modifica</button></a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
