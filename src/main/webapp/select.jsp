            ...
            <body>
                            ...
                            <div class="container-fluid">
                                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                                    <div class="navbar-nav">
                                        <img src="img/unnamed.png" alt="" width="70" height="60" class="d-inline-block align-text-top"> <a class="nav-link" href="index.jsp">Inserimento Candidati</a>
                                    </div>
                                </div>
                            </div>
                        </nav>
				...
				<th scope="col">Note</th>-->
					...
					<td>${listacandidati.note}</td> -->
                                        ...
                                        <td><a href="Appoggio?id=${list.id}&nome=${list.nome}&cognome=${list.cognome}&eta=${list.eta}"><button
										type="button" class="btn btn-primary" data-toggle="modal"
										data-target="#ModeButton">Modifica</button></a></td>
                                    </tr>
                                </c:forEach>
